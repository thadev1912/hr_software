...
<div class="card-header ">
                    <div class="row">
                                  <div class="col-md-12" align="center">
                                       <h1 class="btn text-info"> SỬA THÔNG TIN KHEN THƯỞNG</h1>
                                  </div>
...
<div class="col">
                        ...
                        <input id="current-pass-control" name="txt_ngay_khenthuong" class="form-control" type="date" value="{!! $data->ngay_khenthuong!!}">
